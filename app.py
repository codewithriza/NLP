...
def main():
    ...
    menu = ["Home", "About"]  # Removed "Monitor" from the menu
    choice = st.sidebar.selectbox("Menu", menu)

    if choice == "Home":
        st.subheader("Please enter your emotions as text below")
        ...
        st.subheader("About")
        st.write("Experience our emotion-predicting webapp, powered by NLP with 70% accuracy. We harnessed Python's might with Numpy, Pandas, Seaborn, and more, and Streamlit for the front-end. Our Linear Regression model from Scikit-learn deciphers emotions from speeches, while Joblib keeps the model handy on the website. If you have any questions, email us at codewithriza@gmail.com")
        st.caption('Created by: Riza Mohamed')
